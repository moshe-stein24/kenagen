//! Engine proof of concept — the first thing built for the project.
//!
//! Brings up the audio engine and plays a few canned notes to confirm that
//! `note_on` starts sound and `note_off` actually stops it.
//!
//! Run with: `cargo run --example engine_poc`
